...
class SystemVerifRadioBtnWindow(QWidget):
    ...
    def SetupUI(self):
        ...
        self.Board5_color_label.setStyleSheet("border: 1px solid black;border-radius: 10px; min-height: 18px;min-width: 18px;background-color: red")
        
        self.Board6_color_label = QLabel(self)
        self.Board6_color_label.setStyleSheet("border: 1px solid black;border-radius: 10px; min-height: 18px;min-width: 18px;background-color: red")
        
        self.Board7_color_label = QLabel(self)
        self.Board7_color_label.setStyleSheet("border: 1px solid black;border-radius: 10px; min-height: 18px;min-width: 18px;background-color: red")
        
        self.Brake_color_label  = QLabel(self)
        self.Brake_color_label.setStyleSheet("border: 1px solid black;border-radius: 10px; min-height: 18px;min-width: 18px;background-color: red")
        
        self.CAN_color_label    = QLabel(self)
        self.CAN_color_label.setStyleSheet("border: 1px solid black;border-radius: 10px; min-height: 18px;min-width: 18px;background-color: red")
        ...
        self.YahooPingThread.end.connect(self.on_ping_yahoo)
    ...
    def on_ping_google(self,status):
        if status == 'google is up':
            self.Board5_color_label.setStyleSheet("border: 1px solid black;border-radius: 10px; min-height: 18px;min-width: 18px;background-color: green")
        if status == 'google is down':
            self.Board5_color_label.setStyleSheet("border: 1px solid black;border-radius: 10px; min-height: 18px;min-width: 18px;background-color: red")

    def on_ping_gmail(self,status):
        if status == 'gmail is up':
            self.Board6_color_label.setStyleSheet("border: 1px solid black;border-radius: 10px; min-height: 18px;min-width: 18px;background-color: green")
        if status == 'gmail is down':
            self.Board6_color_label.setStyleSheet("border: 1px solid black;border-radius: 10px; min-height: 18px;min-width: 18px;background-color: red")

    def on_ping_facebook(self,status):
        if status == 'facebook is up':
            self.Board7_color_label.setStyleSheet("border: 1px solid black;border-radius: 10px; min-height: 18px;min-width: 18px;background-color: green")
        if status == 'facebook is down':
            self.Board7_color_label.setStyleSheet("border: 1px solid black;border-radius: 10px; min-height: 18px;min-width: 18px;background-color: red")

    def on_ping_youtube(self,status):
        if status == 'youtube is up':
            self.Brake_color_label.setStyleSheet("border: 1px solid black;border-radius: 10px; min-height: 18px;min-width: 18px;background-color: green")
        if status == 'youtube is down':
            self.Brake_color_label.setStyleSheet("border: 1px solid black;border-radius: 10px; min-height: 18px;min-width: 18px;background-color: red")

    def on_ping_yahoo(self,status):
        if status == 'yahoo is up':
            self.CAN_color_label.setStyleSheet("border: 1px solid black;border-radius: 10px; min-height: 18px;min-width: 18px;background-color: green")
        if status == 'yahoo is down':
            self.CAN_color_label.setStyleSheet("border: 1px solid black;border-radius: 10px; min-height: 18px;min-width: 18px;background-color: red")
...
class SystemNevaWindow(QWidget):
    ...
    def SetupUI(self):
        ...
        self.Volante_reset_button.setStyleSheet('QPushButton {background-color: white; color: black; border-radius:4px; border: 1px solid black;padding:5px 0}'
        ...
        self.Velocidad_reset_button.setStyleSheet('QPushButton {background-color: white; color: black; border-radius:4px; border: 1px solid black;padding:5px 0}'
                             'QPushButton:hover{background-color:lightgray;}')
